...
class CastingAgencyTestCase(unittest.TestCase):
    ...
    def test_create_movie_by_producer(self):
        res = self.client().post(
          '/api/movies',
          json={
        ...
        self.assertEqual(data['success'], True)
        self.assertTrue(data['movie'])
        self.assertEqual(data['movie']['release_date'], '2020-10-08')

    def test_create_movie_by_producer_invalid_date(self):
        res = self.client().post(
          '/api/movies',
          json={
            "title": "the beautiful ones are born",
    ...
    def test_create_movie_by_director(self):
        res = self.client().post(
          '/api/movies',
          json={
            "title": "the beautiful ones are born",
    ...
    def test_patch_movie_by_producer(self):
        res = self.client().patch(
          '/api/movies/1',
          json={"title": "John David"},
          headers={"Authorization": "Bearer " + producer_role_token}
        )
        ...
        self.assertEqual(data['success'], True)
        self.assertTrue(data['movie'])
        self.assertEqual(data['movie']['title'], "John David")

    def test_patch_movie_invalid_id(self):
        res = self.client().patch(
          '/api/movies/80000',
          json={"title": "John David"},
          headers={"Authorization": "Bearer " + producer_role_token}
